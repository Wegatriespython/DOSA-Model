...
def get_market_demand(self, market_type):
    if self.model.step_count < 1:
        ...
        match market_type:
            case 'capital':
                return 6, 3, 1, "none"  # quantity, price, round, market_advantage
            case 'consumption':
                return 30, 1, 1, "none"
            case 'labor':
                return 300, 0.0625, 1, "none"
    ...
    if avg_buyer_price >= avg_seller_price:
        ...
        return clearing_quantity, clearing_price, 1, "none"
